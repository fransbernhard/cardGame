		...
		<div class="wrapper">
			<header id="top">
				...
				<p class="rules-content"  title="Click anywhere to hide the rules">
					...
					<span class="got-it" title="OK, I got it. Let´s play....">OK, I got it. Let´s play....</span>
				</p>
			</header>
			...
			<div class="greentable">
				<div id="area">
					...
					<section class="show-the-cards"></section>
					<div class="whos-turn"></div>
				</div>
			</div>

			<button id="btn-reset">Reset & start over</button>
